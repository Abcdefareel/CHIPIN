                    ...
                    <div class="flex flex-col gap-6">
                        ...
                        <div
                            ...
                            <div class="p-6 flex flex-col gap-4">
                                <!-- Input Pencarian -->
                                <div>
                                    <label class="block text-[0.75rem] font-bold text-[#0d1117] mb-1">Pencarian</label>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <div>
                                        <label class="block text-[0.75rem] font-bold text-[#0d1117] mb-1">Filter Tanggal
                                            Mulai</label>
                                        <input type="date"
                                ...
                                <div class="flex flex-wrap gap-2 pt-2">
                                    <button
                                        class="text-[0.75rem] font-bold px-4 py-1.5 rounded-full transition-all bg-[#0d1117] text-white border border-transparent">
                                        Hadiah
                                    </button>
                                </div>
                                ...
                                <div class="pt-2">
                                    <button
                                        class="w-full bg-[#1a7f64] text-white font-bold text-[0.875rem] py-2.5 rounded-[6px] hover:bg-[#156b54] transition-colors border border-transparent">
                                        Cari
                                    </button>
                                </div>
                            </div>
