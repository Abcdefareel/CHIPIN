...
<head>
    ...
    <title>ChipIN — Reset Password</title>
    ...
    <div
        ...
        <div class="bg-white flex flex-col justify-center p-10 sm:p-16 px-6 sm:px-12 min-h-screen">
            <div class="max-w-[420px] w-full mx-auto">
                <h2 class="text-[1.875rem] font-extrabold text-[#1e1b4b] -tracking-[0.02em] mb-1">Reset Password</h2>
                <p class="text-[0.875rem] text-[#64748b] mb-8">Masukkan kata sandi baru Anda.</p>
                ...
                <form method="POST" action="{{ route('password.reset') }}" class="flex flex-col gap-5">
                    @csrf
                    <div class="flex flex-col gap-2">
                        <label class="text-[0.75rem] font-semibold tracking-wider uppercase text-[#64748b]">New
                            Password</label>
                    ...
                    <div class="flex flex-col gap-2">
                        <label class="text-[0.75rem] font-semibold tracking-wider uppercase text-[#64748b]">Confirm
                            Password</label>
                    ...
                    <button type="submit"
                        class="inline-flex items-center justify-center gap-2 text-[0.875rem] font-semibold leading-none p-[0.875rem] px-6 rounded-2xl bg-gradient-to-r from-indigo-600 to-violet-600 text-white w-full">Reset
                        Password</button>
                </form>
